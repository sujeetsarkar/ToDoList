...
import { FormBuilder, FormGroup, Validators, FormControl, AbstractControl, ReactiveFormsModule, FormsModule } from '@angular/forms';
...
@Component({ templateUrl: 'register.component.html', imports: [CommonModule, ReactiveFormsModule] })
